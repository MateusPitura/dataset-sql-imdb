...
The data was downloaded from [CS50](https://url.mateuspitura.com?q=cs50.harvard.edu/x/2023/psets/7/movies/), a course at Harvard University. The data was in SQLite3, but has been converted to MySQL and Postgres for ease of use. It's possible to download the original data from the [IMDb site](https://url.mateuspitura.com?q=developer.imdb.com/non-commercial-datasets/)
